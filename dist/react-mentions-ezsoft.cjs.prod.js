...
var _toConsumableArray = _interopDefault(require("@babel/runtime/helpers/toConsumableArray")), _extends = _interopDefault(require("@babel/runtime/helpers/extends")), _classCallCheck = _interopDefault(require("@babel/runtime/helpers/classCallCheck")), _createClass = _interopDefault(require("@babel/runtime/helpers/createClass")), _assertThisInitialized = _interopDefault(require("@babel/runtime/helpers/assertThisInitialized")), _inherits = _interopDefault(require("@babel/runtime/helpers/inherits")), _possibleConstructorReturn = _interopDefault(require("@babel/runtime/helpers/possibleConstructorReturn")), _getPrototypeOf = _interopDefault(require("@babel/runtime/helpers/getPrototypeOf")), _defineProperty = _interopDefault(require("@babel/runtime/helpers/defineProperty")), React = require("react"), React__default = _interopDefault(React), invariant = _interopDefault(require("invariant")), _slicedToArray = _interopDefault(require("@babel/runtime/helpers/slicedToArray")), _objectWithoutProperties = _interopDefault(require("@babel/runtime/helpers/objectWithoutProperties")), useStyles = require("substyle"), useStyles__default = _interopDefault(useStyles), PropTypes = _interopDefault(require("prop-types")), ReactDOM = _interopDefault(require("react-dom")), escapeRegex = function(str) {
  ...
  var mappedSpliceStart = spliceStart, mappedSpliceEnd = spliceEnd, newValue = (mapPlainTextIndex(value, config, spliceStart, "NULL"), 
  mapPlainTextIndex(value, config, spliceEnd, "NULL"), spliceString(value, mappedSpliceStart, mappedSpliceEnd, insert)), controlPlainTextValue = getPlainText(newValue, config);
...
}), SuggestionsOverlay$1 = styled$2(SuggestionsOverlay), isRedo = function(event) {
...
var makeTriggerRegex = function(trigger) {
  ...
  var allowSpaceInQuery = options.allowSpaceInQuery, escapedTriggerChar = trigger;
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setContainerElement", function(el) {
      ...
      _this.redo = [], null != _this.last && _this.undo.push(_this.last), _this.last = event.target.value;
    ...
    }), _defineProperty(_assertThisInitialized(_this), "doUndo", function() {
      if (_this.undo.length > 0) {
        _this.redo.push(_this.props.value);
        var val = _this.undo.pop();
        _this.last = val, _this.props.onChange({
          target: {
            value: val
          }
        });
      }
    }), _defineProperty(_assertThisInitialized(_this), "doRedo", function() {
      if (_this.redo.length > 0) {
        var val = _this.redo.pop();
        _this.undo.push(_this.props.value), _this.last = null, _this.props.onChange({
          target: {
            value: val
          }
        });
      ...
      }, config), selectionStart = ev.target.selectionStart, selectionEnd = ev.target.selectionEnd;
      _this.setState({
        selectionStart: selectionStart,
        selectionEnd: selectionEnd,
      ...
      if (isUndo(ev)) return _this.doUndo(), void ev.preventDefault();
      if (isRedo(ev)) return _this.doRedo(), void ev.preventDefault();
    ...
    _this.loads = [], _this.undo = [], _this.redo = [], _this.ref = _props.value, _this.last = _props.value || "", 
    _this.schedules = [], _this.state = {
      focusIndex: 0,
      selectionStart: null,
      selectionEnd: null,
      suggestions: {},
  ...
  return _createClass(MentionsInput, [ {
    ...
    value: function(event) {
      if (event.target === this.inputElement && this.supportsClipboardActions(event) && this.props.replaceMarkupOnPaste) {
...
var getComputedStyleLengthProp = function(forElement, propertyName) {
  ...
  return React__default.createElement("strong", _extends({}, styles, {
    className: className
  }), display);
};
